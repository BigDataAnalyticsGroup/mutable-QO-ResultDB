...
def create_q1b():
	...
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year >= 2005', 't.production_year <= 2010'], projections = [])
...
def create_q2a():
	cn = Relation(name = "company_name", alias = "cn", attributes = ['id', 'country_code'], filters = ['cn.country_code ="[de]"'], projections = [])
	k = Relation(name = "keyword", alias = "k", attributes = ['id', 'keyword'], filters = ['k.keyword ="character-name-in-title"'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id'], filters = [], projections = [])
...
def create_q3c():
	...
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year > 1990'], projections = [])
	relations = [k, mi, mk, t]
...
def create_q4a():
	...
	k = Relation(name = "keyword", alias = "k", attributes = ['id', 'keyword'], filters = ['k.keyword LIKE "%sequel%"'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['mi_idx.info > "5.0"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year > 2005'], projections = [])
...
def create_q5c():
	...
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['(mi.info = "Sweden" OR mi.info = "Norway" OR mi.info = "Germany" OR mi.info = "Denmark" OR mi.info = "Swedish" OR mi.info = "Denish" OR mi.info = "Norwegian" OR mi.info = "German" OR mi.info = "USA" OR mi.info = "American")'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year > 1990'], projections = [])
...
def create_q7a():
	...
	ml = Relation(name = "movie_link", alias = "ml", attributes = ['link_type_id', 'linked_movie_id'], filters = [], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['name', 'gender', 'name_pcode_cf', 'id'], filters = ['n.name_pcode_cf >= "A"', 'n.name_pcode_cf <= "F"', '(n.gender= "m" OR (n.gender = "f" AND n.name LIKE "B%"))'], projections = [])
	pi = Relation(name = "person_info", alias = "pi", attributes = ['info_type_id', 'note', 'person_id'], filters = ['pi.note = "Volker Boehm"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year >= 1980', 't.production_year <= 1995'], projections = [])
...
def create_q8a():
	...
	ci = Relation(name = "cast_info", alias = "ci", attributes = ['movie_id', 'note', 'person_id', 'role_id'], filters = ['ci.note ="(voice: English version)"'], projections = [])
	cn = Relation(name = "company_name", alias = "cn", attributes = ['id', 'country_code'], filters = ['cn.country_code ="[jp]"'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'note', 'movie_id'], filters = ['mc.note LIKE "%(Japan)%"', 'NOT mc.note LIKE "%(USA)%"'], projections = [])
	n1 = Relation(name = "name", alias = "n1", attributes = ['name', 'id'], filters = ['n1.name LIKE "%Yo%"', 'NOT n1.name LIKE "%Yu%"'], projections = [])
	rt = Relation(name = "role_type", alias = "rt", attributes = ['id', 'role'], filters = ['rt.role ="actress"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id'], filters = [], projections = [])
...
def create_q9c():
	...
	ci = Relation(name = "cast_info", alias = "ci", attributes = ['note', 'movie_id', 'person_id', 'role_id', 'person_role_id'], filters = ['(ci.note = "(voice)" OR ci.note = "(voice: Japanese version)" OR ci.note = "(voice) (uncredited)" OR ci.note = "(voice: English version)")'], projections = [])
	cn = Relation(name = "company_name", alias = "cn", attributes = ['id', 'country_code'], filters = ['cn.country_code ="[us]"'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id'], filters = [], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['name', 'gender', 'id'], filters = ['n.gender ="f"', 'n.name LIKE "%An%"'], projections = [])
	rt = Relation(name = "role_type", alias = "rt", attributes = ['id', 'role'], filters = ['rt.role ="actress"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id'], filters = [], projections = [])
...
def create_q10c():
	chn = Relation(name = "char_name", alias = "chn", attributes = ['id'], filters = [], projections = [])
	ci = Relation(name = "cast_info", alias = "ci", attributes = ['movie_id', 'note', 'person_role_id', 'role_id'], filters = ['ci.note LIKE "%(producer)%"'], projections = [])
	cn = Relation(name = "company_name", alias = "cn", attributes = ['id', 'country_code'], filters = ['cn.country_code = "[us]"'], projections = [])
	ct = Relation(name = "company_type", alias = "ct", attributes = ['id'], filters = [], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id', 'company_type_id'], filters = [], projections = [])
...
def create_q11c():
	...
	ct = Relation(name = "company_type", alias = "ct", attributes = ['id', 'kind'], filters = ['ct.kind != "production companies"', 'NOT ISNULL(ct.kind)'], projections = [])
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id', 'note', 'company_type_id'], filters = ['NOT ISNULL(mc.note)'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	ml = Relation(name = "movie_link", alias = "ml", attributes = ['movie_id', 'link_type_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year > 1950'], projections = [])
...
def create_q12a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id', 'company_type_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['(mi.info = "Drama" OR mi.info = "Horror")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['mi_idx.info > "8.0"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year >= 2005', 't.production_year <= 2008'], projections = [])
...
def create_q14a():
	...
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['(mi.info = "Sweden" OR mi.info = "Norway" OR mi.info = "Germany" OR mi.info = "Denmark" OR mi.info = "Swedish" OR mi.info = "Denish" OR mi.info = "Norwegian" OR mi.info = "German" OR mi.info = "USA" OR mi.info = "American")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['mi_idx.info < "8.5"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year', 'kind_id'], filters = ['t.production_year > 2010'], projections = [])
...
def create_q15d():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id', 'company_type_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['movie_id', 'info_type_id', 'note'], filters = ['mi.note LIKE "%internet%"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year > 1990'], projections = [])
...
def create_q18c():
	...
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['(mi.info = "Horror" OR mi.info = "Action" OR mi.info = "Sci-Fi" OR mi.info = "Thriller" OR mi.info = "Crime" OR mi.info = "War")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['movie_id', 'info_type_id'], filters = [], projections = [])
...
def create_q19a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id', 'note'], filters = ['NOT ISNULL(mc.note)', '(mc.note LIKE "%(USA)%" OR mc.note LIKE "%(worldwide)%")'], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['NOT ISNULL(mi.info)', '(mi.info LIKE "Japan:%200%" OR mi.info LIKE "USA:%200%")'], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['name', 'gender', 'id'], filters = ['n.gender ="f"', 'n.name LIKE "%Ang%"'], projections = [])
	rt = Relation(name = "role_type", alias = "rt", attributes = ['id', 'role'], filters = ['rt.role ="actress"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year >= 2005', 't.production_year <= 2009'], projections = [])
...
def create_q21a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'note', 'movie_id', 'company_type_id'], filters = ['ISNULL(mc.note)'], projections = [])
	...
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	ml = Relation(name = "movie_link", alias = "ml", attributes = ['movie_id', 'link_type_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year >= 1950', 't.production_year <= 2000'], projections = [])
...
def create_q22c():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id', 'note', 'company_type_id'], filters = ['NOT mc.note LIKE "%(USA)%"', 'mc.note LIKE "%(200%)%"'], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['(mi.info = "Sweden" OR mi.info = "Norway" OR mi.info = "Germany" OR mi.info = "Denmark" OR mi.info = "Swedish" OR mi.info = "Danish" OR mi.info = "Norwegian" OR mi.info = "German" OR mi.info = "USA" OR mi.info = "American")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['mi_idx.info < "8.5"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year', 'kind_id'], filters = ['t.production_year > 2005'], projections = [])
...
def create_q23a():
	...
	kt = Relation(name = "kind_type", alias = "kt", attributes = ['id', 'kind'], filters = ['(kt.kind = "movie")'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id', 'company_type_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id', 'note'], filters = ['mi.note LIKE "%internet%"', 'NOT ISNULL(mi.info)', '(mi.info LIKE "USA:% 199%" OR mi.info LIKE "USA:% 200%")'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year', 'kind_id'], filters = ['t.production_year > 2000'], projections = [])
...
def create_q24a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['NOT ISNULL(mi.info)', '(mi.info LIKE "Japan:%201%" OR mi.info LIKE "USA:%201%")'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['name', 'gender', 'id'], filters = ['n.gender ="f"', 'n.name LIKE "%An%"'], projections = [])
	rt = Relation(name = "role_type", alias = "rt", attributes = ['id', 'role'], filters = ['rt.role ="actress"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year'], filters = ['t.production_year > 2010'], projections = [])
...
def create_q25b():
	...
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['mi.info = "Horror"'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['movie_id', 'info_type_id'], filters = [], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['gender', 'id'], filters = ['n.gender = "m"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id', 'production_year', 'title'], filters = ['t.production_year > 2010', 't.title LIKE "Vampire%"'], projections = [])
...
def create_q26a():
	...
	chn = Relation(name = "char_name", alias = "chn", attributes = ['name', 'id'], filters = ['NOT ISNULL(chn.name)', '(chn.name LIKE "%man%" OR chn.name LIKE "%Man%")'], projections = [])
	...
	kt = Relation(name = "kind_type", alias = "kt", attributes = ['id', 'kind'], filters = ['kt.kind = "movie"'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['mi_idx.info > "7.0"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
...
def create_q27a():
	...
	k = Relation(name = "keyword", alias = "k", attributes = ['id', 'keyword'], filters = ['k.keyword ="sequel"'], projections = [])
	lt = Relation(name = "link_type", alias = "lt", attributes = ['link', 'id'], filters = ['lt.link LIKE "%follow%"'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id', 'note', 'company_type_id'], filters = ['ISNULL(mc.note)'], projections = [])
...
def create_q31a():
	...
	k = Relation(name = "keyword", alias = "k", attributes = ['id', 'keyword'], filters = ['(k.keyword = "murder" OR k.keyword = "violence" OR k.keyword = "blood" OR k.keyword = "gore" OR k.keyword = "death" OR k.keyword = "female-nudity" OR k.keyword = "hospital")'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['company_id', 'movie_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['(mi.info = "Horror" OR mi.info = "Thriller")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['movie_id', 'info_type_id'], filters = [], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['keyword_id', 'movie_id'], filters = [], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['gender', 'id'], filters = ['n.gender = "m"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id'], filters = [], projections = [])
...
def create_q33c():
	cn1 = Relation(name = "company_name", alias = "cn1", attributes = ['id', 'country_code'], filters = ['cn1.country_code != "[us]"'], projections = [])
	...
	mc1 = Relation(name = "movie_companies", alias = "mc1", attributes = ['company_id', 'movie_id'], filters = [], projections = [])
	mc2 = Relation(name = "movie_companies", alias = "mc2", attributes = ['company_id', 'movie_id'], filters = [], projections = [])
	mi_idx1 = Relation(name = "movie_info_idx", alias = "mi_idx1", attributes = ['movie_id', 'info_type_id'], filters = [], projections = [])
	mi_idx2 = Relation(name = "movie_info_idx", alias = "mi_idx2", attributes = ['info', 'movie_id', 'info_type_id'], filters = ['mi_idx2.info < "3.5"'], projections = [])
	ml = Relation(name = "movie_link", alias = "ml", attributes = ['movie_id', 'link_type_id', 'linked_movie_id'], filters = [], projections = [])
	t1 = Relation(name = "title", alias = "t1", attributes = ['id', 'kind_id'], filters = [], projections = [])
	t2 = Relation(name = "title", alias = "t2", attributes = ['id', 'production_year', 'kind_id'], filters = ['t2.production_year >= 2000', 't2.production_year <= 2010'], projections = [])
