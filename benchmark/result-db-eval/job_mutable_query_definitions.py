...
def create_q11c():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'note', 'company_type_id', 'company_id'], filters = ['NOT ISNULL(mc.note)'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
...
def create_q19a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'note', 'company_id'], filters = ['NOT ISNULL(mc.note)', '(mc.note LIKE "%(USA)%" OR mc.note LIKE "%(worldwide)%")'], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['movie_id', 'info', 'info_type_id'], filters = ['NOT ISNULL(mi.info)', '(mi.info LIKE "Japan:%200%" OR mi.info LIKE "USA:%200%")'], projections = [])
...
def create_q21a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'note', 'company_type_id', 'company_id'], filters = ['ISNULL(mc.note)'], projections = [])
...
def create_q23a():
	...
	kt = Relation(name = "kind_type", alias = "kt", attributes = ['kind', 'id'], filters = ['(kt.kind = "movie")'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'company_id', 'company_type_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['movie_id', 'note', 'info', 'info_type_id'], filters = ['mi.note LIKE "%internet%"', 'ISNULL(mi.info))', '(mi.info LIKE "USA:% 199%" OR mi.info LIKE "USA:% 200%")'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
...
def create_q24a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'company_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['movie_id', 'info', 'info_type_id'], filters = ['ISNULL(mi.info)', '(mi.info LIKE "Japan:%201%" OR mi.info LIKE "USA:%201%")'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['gender', 'name', 'id'], filters = ['n.gender ="f"', 'n.name LIKE "%An%"'], projections = [])
	rt = Relation(name = "role_type", alias = "rt", attributes = ['role', 'id'], filters = ['rt.role ="actress"'], projections = [])
...
def create_q26a():
	...
	chn = Relation(name = "char_name", alias = "chn", attributes = ['name', 'id'], filters = ['ISNULL(chn.name)', '(chn.name LIKE "%man%" OR chn.name LIKE "%Man%")'], projections = [])
