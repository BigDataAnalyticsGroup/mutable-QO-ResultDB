...
def create_q1b():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['note', 'movie_id', 'company_type_id'], filters = ['NOT mc.note LIKE "%(as Metro-Goldwyn-Mayer Pictures)%"'], projections = [])
...
def create_q4a():
	...
	k = Relation(name = "keyword", alias = "k", attributes = ['id', 'keyword'], filters = ['k.keyword LIKE "%sequel%"'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['mi_idx.info > "5.0"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
...
def create_q5c():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['note', 'movie_id', 'company_type_id'], filters = ['NOT mc.note LIKE "%(TV)%"', 'mc.note LIKE "%(USA)%"'], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['(mi.info = "Sweden" OR mi.info = "Norway" OR mi.info = "Germany" OR mi.info = "Denmark" OR mi.info = "Swedish" OR mi.info = "Denish" OR mi.info = "Norwegian" OR mi.info = "German" OR mi.info = "USA" OR mi.info = "American")'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['production_year', 'id'], filters = ['t.production_year > 1990'], projections = [])
...
def create_q7a():
	...
	n = Relation(name = "name", alias = "n", attributes = ['name_pcode_cf', 'gender', 'name', 'id'], filters = ['n.name_pcode_cf >= "A"', 'n.name_pcode_cf <= "F"', '(n.gender= "m" OR (n.gender = "f" AND n.name LIKE "B%"))'], projections = [])
	pi = Relation(name = "person_info", alias = "pi", attributes = ['note', 'info_type_id', 'person_id'], filters = ['pi.note = "Volker Boehm"'], projections = [])
...
def create_q8a():
	...
	ci = Relation(name = "cast_info", alias = "ci", attributes = ['note', 'movie_id', 'person_id', 'role_id'], filters = ['ci.note ="(voice: English version)"'], projections = [])
	cn = Relation(name = "company_name", alias = "cn", attributes = ['country_code', 'id'], filters = ['cn.country_code ="[jp]"'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['note', 'company_id', 'movie_id'], filters = ['mc.note LIKE "%(Japan)%"', 'NOT mc.note LIKE "%(USA)%"'], projections = [])
	n1 = Relation(name = "name", alias = "n1", attributes = ['id', 'name'], filters = ['n1.name LIKE "%Yo%"', 'NOT n1.name LIKE "%Yu%"'], projections = [])
...
def create_q9c():
	...
	ci = Relation(name = "cast_info", alias = "ci", attributes = ['note', 'role_id', 'movie_id', 'person_role_id', 'person_id'], filters = ['(ci.note = "(voice)" OR ci.note = "(voice: Japanese version)" OR ci.note = "(voice) (uncredited)" OR ci.note = "(voice: English version)")'], projections = [])
...
def create_q10c():
	chn = Relation(name = "char_name", alias = "chn", attributes = ['id'], filters = [], projections = [])
	ci = Relation(name = "cast_info", alias = "ci", attributes = ['note', 'person_role_id', 'movie_id', 'role_id'], filters = ['ci.note LIKE "%(producer)%"'], projections = [])
	cn = Relation(name = "company_name", alias = "cn", attributes = ['country_code', 'id'], filters = ['cn.country_code = "[us]"'], projections = [])
...
def create_q11c():
	cn = Relation(name = "company_name", alias = "cn", attributes = ['country_code', 'id', 'name'], filters = ['cn.country_code !="[pl]"', '(cn.name LIKE "20th Century Fox%" OR cn.name LIKE "Twentieth Century Fox%")'], projections = [])
	ct = Relation(name = "company_type", alias = "ct", attributes = ['kind', 'id'], filters = ['ct.kind != "production companies"', 'NOT ISNULL(ct.kind)'], projections = [])
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['note', 'company_id', 'movie_id', 'company_type_id'], filters = ['NOT ISNULL(mc.note)'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
...
def create_q12a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'company_id', 'company_type_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['(mi.info = "Drama" OR mi.info = "Horror")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['mi_idx.info > "8.0"'], projections = [])
...
def create_q14a():
	...
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['(mi.info = "Sweden" OR mi.info = "Norway" OR mi.info = "Germany" OR mi.info = "Denmark" OR mi.info = "Swedish" OR mi.info = "Denish" OR mi.info = "Norwegian" OR mi.info = "German" OR mi.info = "USA" OR mi.info = "American")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['mi_idx.info < "8.5"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['production_year', 'kind_id', 'id'], filters = ['t.production_year > 2010'], projections = [])
...
def create_q15d():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'company_id', 'company_type_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['note', 'info_type_id', 'movie_id'], filters = ['mi.note LIKE "%internet%"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['production_year', 'id'], filters = ['t.production_year > 1990'], projections = [])
...
def create_q18c():
	ci = Relation(name = "cast_info", alias = "ci", attributes = ['note', 'movie_id', 'person_id'], filters = ['(ci.note = "(writer)" OR ci.note = "(head writer)" OR ci.note = "(written by)" OR ci.note = "(story)" OR ci.note = "(story editor)")'], projections = [])
	it1 = Relation(name = "info_type", alias = "it1", attributes = ['id', 'info'], filters = ['it1.info = "genres"'], projections = [])
	it2 = Relation(name = "info_type", alias = "it2", attributes = ['id', 'info'], filters = ['it2.info = "votes"'], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['(mi.info = "Horror" OR mi.info = "Action" OR mi.info = "Sci-Fi" OR mi.info = "Thriller" OR mi.info = "Crime" OR mi.info = "War")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['movie_id', 'info_type_id'], filters = [], projections = [])
...
def create_q19a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['note', 'company_id', 'movie_id'], filters = ['NOT ISNULL(mc.note)', '(mc.note LIKE "%(USA)%" OR mc.note LIKE "%(worldwide)%")'], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['NOT ISNULL(mi.info)', '(mi.info LIKE "Japan:%200%" OR mi.info LIKE "USA:%200%")'], projections = [])
...
def create_q21a():
	cn = Relation(name = "company_name", alias = "cn", attributes = ['country_code', 'id', 'name'], filters = ['cn.country_code !="[pl]"', '(cn.name LIKE "%Film%" OR cn.name LIKE "%Warner%")'], projections = [])
	ct = Relation(name = "company_type", alias = "ct", attributes = ['kind', 'id'], filters = ['ct.kind ="production companies"'], projections = [])
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['note', 'company_id', 'movie_id', 'company_type_id'], filters = ['ISNULL(mc.note)'], projections = [])
	...
	j6 = Join(ml, mc, ["movie_id"], ["movie_id"])
	j7 = Join(mk, mi, ["movie_id"], ["movie_id"])
	joins = [j0, j1, j2, j3, j4, j5, j6, j7]
...
def create_q22c():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['note', 'company_id', 'movie_id', 'company_type_id'], filters = ['NOT mc.note LIKE "%(USA)%"', 'mc.note LIKE "%(200%)%"'], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['(mi.info = "Sweden" OR mi.info = "Norway" OR mi.info = "Germany" OR mi.info = "Denmark" OR mi.info = "Swedish" OR mi.info = "Danish" OR mi.info = "Norwegian" OR mi.info = "German" OR mi.info = "USA" OR mi.info = "American")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['mi_idx.info < "8.5"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['production_year', 'kind_id', 'id'], filters = ['t.production_year > 2005'], projections = [])
	...
	j4 = Join(mi, mc, ["movie_id"], ["movie_id"])
...
def create_q23a():
	...
	kt = Relation(name = "kind_type", alias = "kt", attributes = ['kind', 'id'], filters = ['(kt.kind = "movie")'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'company_id', 'company_type_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['note', 'info_type_id', 'movie_id', 'info'], filters = ['mi.note LIKE "%internet%"', 'NOT ISNULL(mi.info)', '(mi.info LIKE "USA:% 199%" OR mi.info LIKE "USA:% 200%")'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['production_year', 'kind_id', 'id'], filters = ['t.production_year > 2000'], projections = [])
...
def create_q24a():
	...
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'company_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['NOT ISNULL(mi.info)', '(mi.info LIKE "Japan:%201%" OR mi.info LIKE "USA:%201%")'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['gender', 'name', 'id'], filters = ['n.gender ="f"', 'n.name LIKE "%An%"'], projections = [])
	rt = Relation(name = "role_type", alias = "rt", attributes = ['id', 'role'], filters = ['rt.role ="actress"'], projections = [])
	...
	j1 = Join(t, ci, ["id"], ["movie_id"])
	j2 = Join(mc, mi, ["movie_id"], ["movie_id"])
	j3 = Join(mi, ci, ["movie_id"], ["movie_id"])
	j4 = Join(mi, mk, ["movie_id"], ["movie_id"])
	j5 = Join(cn, mc, ["id"], ["company_id"])
	j6 = Join(it, mi, ["id"], ["info_type_id"])
	j7 = Join(n, ci, ["id"], ["person_id"])
	j8 = Join(rt, ci, ["id"], ["role_id"])
	j9 = Join(ci, an, ["person_id"], ["person_id"])
	j10 = Join(chn, ci, ["id"], ["person_role_id"])
	j11 = Join(k, mk, ["id"], ["keyword_id"])
...
def create_q25b():
	...
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['mi.info = "Horror"'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['movie_id', 'info_type_id'], filters = [], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['gender', 'id'], filters = ['n.gender = "m"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['production_year', 'id', 'title'], filters = ['t.production_year > 2010', 't.title LIKE "Vampire%"'], projections = [])
...
def create_q26a():
	cc = Relation(name = "complete_cast", alias = "cc", attributes = ['subject_id', 'status_id', 'movie_id'], filters = [], projections = [])
	...
	chn = Relation(name = "char_name", alias = "chn", attributes = ['id', 'name'], filters = ['NOT ISNULL(chn.name)', '(chn.name LIKE "%man%" OR chn.name LIKE "%Man%")'], projections = [])
	ci = Relation(name = "cast_info", alias = "ci", attributes = ['movie_id', 'person_role_id', 'person_id'], filters = [], projections = [])
	it2 = Relation(name = "info_type", alias = "it2", attributes = ['id', 'info'], filters = ['it2.info = "rating"'], projections = [])
	...
	kt = Relation(name = "kind_type", alias = "kt", attributes = ['kind', 'id'], filters = ['kt.kind = "movie"'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['mi_idx.info > "7.0"'], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
...
def create_q27a():
	...
	j0 = Join(lt, ml, ["id"], ["link_type_id"])
	j1 = Join(mk, k, ["keyword_id"], ["id"])
	j2 = Join(t, mc, ["id"], ["movie_id"])
	j3 = Join(mc, ct, ["company_type_id"], ["id"])
	j4 = Join(mc, cn, ["company_id"], ["id"])
	j5 = Join(cct1, cc, ["id"], ["subject_id"])
	j6 = Join(cct2, cc, ["id"], ["status_id"])
	j7 = Join(ml, mk, ["movie_id"], ["movie_id"])
	j8 = Join(ml, cc, ["movie_id"], ["movie_id"])
	j9 = Join(mc, cc, ["movie_id"], ["movie_id"])
...
def create_q28c():
	...
	j2 = Join(mk, mi, ["movie_id"], ["movie_id"])
	j3 = Join(mk, mi_idx, ["movie_id"], ["movie_id"])
	j4 = Join(mi, cc, ["movie_id"], ["movie_id"])
	j5 = Join(mc, mi_idx, ["movie_id"], ["movie_id"])
...
def create_q31a():
	ci = Relation(name = "cast_info", alias = "ci", attributes = ['note', 'movie_id', 'person_id'], filters = ['(ci.note = "(writer)" OR ci.note = "(head writer)" OR ci.note = "(written by)" OR ci.note = "(story)" OR ci.note = "(story editor)")'], projections = [])
	cn = Relation(name = "company_name", alias = "cn", attributes = ['id', 'name'], filters = ['cn.name LIKE "Lionsgate%"'], projections = [])
	it1 = Relation(name = "info_type", alias = "it1", attributes = ['id', 'info'], filters = ['it1.info = "genres"'], projections = [])
	it2 = Relation(name = "info_type", alias = "it2", attributes = ['id', 'info'], filters = ['it2.info = "votes"'], projections = [])
	k = Relation(name = "keyword", alias = "k", attributes = ['id', 'keyword'], filters = ['(k.keyword = "murder" OR k.keyword = "violence" OR k.keyword = "blood" OR k.keyword = "gore" OR k.keyword = "death" OR k.keyword = "female-nudity" OR k.keyword = "hospital")'], projections = [])
	mc = Relation(name = "movie_companies", alias = "mc", attributes = ['movie_id', 'company_id'], filters = [], projections = [])
	mi = Relation(name = "movie_info", alias = "mi", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['(mi.info = "Horror" OR mi.info = "Thriller")'], projections = [])
	mi_idx = Relation(name = "movie_info_idx", alias = "mi_idx", attributes = ['movie_id', 'info_type_id'], filters = [], projections = [])
	mk = Relation(name = "movie_keyword", alias = "mk", attributes = ['movie_id', 'keyword_id'], filters = [], projections = [])
	n = Relation(name = "name", alias = "n", attributes = ['gender', 'id'], filters = ['n.gender = "m"'], projections = [])
	t = Relation(name = "title", alias = "t", attributes = ['id'], filters = [], projections = [])
	...
	j0 = Join(t, mi, ["id"], ["movie_id"])
	j1 = Join(ci, mi, ["movie_id"], ["movie_id"])
	j2 = Join(ci, mk, ["movie_id"], ["movie_id"])
	j3 = Join(ci, mc, ["movie_id"], ["movie_id"])
...
def create_q33c():
	...
	mi_idx2 = Relation(name = "movie_info_idx", alias = "mi_idx2", attributes = ['info', 'info_type_id', 'movie_id'], filters = ['mi_idx2.info < "3.5"'], projections = [])
	...
	t2 = Relation(name = "title", alias = "t2", attributes = ['production_year', 'id', 'kind_id'], filters = ['t2.production_year >= 2000', 't2.production_year <= 2010'], projections = [])
	...
	j8 = Join(it2, mi_idx2, ["id"], ["info_type_id"])
	j9 = Join(t2, mi_idx2, ["id"], ["movie_id"])
	j10 = Join(kt2, t2, ["id"], ["kind_id"])
	j11 = Join(cn2, mc2, ["id"], ["company_id"])
	j12 = Join(t2, mc2, ["id"], ["movie_id"])
	joins = [j0, j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12]
