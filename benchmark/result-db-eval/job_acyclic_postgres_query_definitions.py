...
def create_q7a():
	...
	n = Relation(name = "name", alias = "n", attributes = ['gender', 'name', 'name_pcode_cf', 'id'], filters = ['n.name_pcode_cf >= "A"', 'n.name_pcode_cf <= "F"', '(n.gender= "m" OR (n.gender = "f" AND n.name LIKE "B%"))'], projections = [])
