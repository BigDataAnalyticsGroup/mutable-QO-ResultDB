...
WHERE
	...
	(kt.kind = "movie" OR kt.kind = "episode") AND
	NOT mc.note LIKE "%(USA)%" AND
	mc.note LIKE "%(200%)%" AND
	(mi.info = "Sweden" OR mi.info = "Norway" OR mi.info = "Germany" OR mi.info = "Denmark" OR mi.info = "Swedish" OR mi.info = "Danish" OR mi.info = "Norwegian" OR mi.info = "German" OR mi.info = "USA" OR mi.info = "American") AND
	mi_idx.info < "8.5" AND
